...
$lblCambio	 	= array("refclientes","reftipoventa","fechacreacion");
$lblreemplazo	= array("Cliente","Estado Venta","Fecha Creación");


$resTV 	= $serviciosReferencias->traerTipoventa();
$cadRef 	= $serviciosFunciones->devolverSelectBox($resTV,array(1),'');

$resC 	= $serviciosReferencias->traerClientes();
$cadRef2 	= $serviciosFunciones->devolverSelectBox($resC,array(1,2),' ');
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerVentas(),10);
