...
$cadRef 	= $serviciosFunciones->devolverSelectBoxActivo($resTV,array(1),'', mysql_result($resResultado,0,'reftipoventa'));

$resC 	= $serviciosReferencias->traerClientes();
$cadRef2 	= $serviciosFunciones->devolverSelectBoxActivo($resC, array(1),'', mysql_result($resResultado,0,'refclientes'));
