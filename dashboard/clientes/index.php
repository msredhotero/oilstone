...
$lblCambio	 	= array("nrodocumento","fechanacimiento","telefono");
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerClientes(),4);
    	...
    	<div class="cuerpoBox">
            ...
            <div class="row">
                ...
                <ul class="list-inline" style="margin-top:15px;">
                    ...
                    <li>
                        <button type="button" class="btn btn-warning" id="cargarventa" style="margin-left:0px;">Guardar y Cargar Venta</button>
                    </li>
                </ul>
                </div>
            </div>
    ...
    $('#cargarventa').click(function(){
		...
		if (validador() == "")
        {
			...
			$.ajax({
					...
					success:  function (response) {
						if (!isNaN(response)) {
							url = "../ventas/venta.php?idCliente="+response;
							$(location).attr('href',url);
						} else {
							$(".alert").removeClass("alert-danger");
							$(".alert").addClass("alert-danger");
