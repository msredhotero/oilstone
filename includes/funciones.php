				...
				if ($row[3] != 'PRI') {
					if (strpos($row[1],"decimal") !== false) {
						...
						if ( in_array($row[0],$refCampo) ) {
							...
							$autocompletar = array("refclientes");
							...
							if (in_array($campo,$autocompletar)) {
								...
								<div class="form-group col-md-6" style="display:'.$lblOculta.'">
									...
									<div class="input-group col-md-12">
										...
										<select data-placeholder="selecione el '.$label.'..." id="'.strtolower($campo).'" name="'.strtolower($campo).'" style="width:500px;" class="chosen-select" tabindex="2">
            								<option value=""></option>
											';
